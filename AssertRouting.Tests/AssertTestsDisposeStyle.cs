...
{
    [TestClass]
    public class AssertTestsDisposeStyle
    {
        [TestMethod]
        ...
        [TestMethod]
        public void InnerSupressorRestoresPreviousOffSettings_OldStyle()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(AssertTriggeredException))]
        public void InnerSupressorRestoresPreviousOnSettings_OldStyle()
        {
            using (AssertRouter outerSupressor = new AssertRouter(AssertUIBehaviour.DisableUIAndThrowExceptions))
            {
                bool innerSupressorTriggersException = false;
